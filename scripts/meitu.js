...
if ($request.url.indexOf(hysj) != -1) {
	chxm1023.data = {
		...
		"pay_interval": 3000,
		"beautify_prompt": "",
		"home_prompt": "Membership valid until 2099/09/09",
		"svip_bubble_text": "Diamond SVIP: Valid until 2099/09/09\nDiamond VIP: Valid until 2099/09/99",
		"beautify_btn_prompt": "",
...
if ($request.url.indexOf(hyzl) != -1) {
	...
	chxm1023.data.rights_page_vip_btn_title = "Unlock Now";
	chxm1023.data.rights_page_svip_btn_title = "Unlock Now";
...
if ($request.url.indexOf(group) != -1) {
	chxm1023.data = {
		...
		"limit_type": 0,
		"active_sub_type_name": "Renewal",
		"use_vip": true,
		"have_valid_contract": false,
		"derive_type_name": "Regular Member",
		"derive_type": 1,
...
if ($request.url.indexOf(sjs) != -1) {
	chxm1023.data = {
		...
		"rights_info": [
			{
				"show_tips": "Remaining number of cutouts: 9999999 >",
				"commodity_unit": "2",
				"link_words": "9999999 >",
